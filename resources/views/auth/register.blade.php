        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col col-xl-10">
                ...
                <div class="row g-0">
                    ...
                    <img
                        src="images/login-register/register-cacti.jpg"
                        alt="login form"
                    ...
                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                        <div class="card-body p-4 p-lg-5 text-black">
                            <form method="POST" action="{{ route('register') }}"> 
                                ...
                                <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Sign up for your account</h5>
                                ...
                                <button type="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">{{ __('Register') }}</button>
                                </div>
